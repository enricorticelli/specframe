...
4. Allocate the file through the CLI — `specframe doc new <rule|guideline|runbook|glossary> <slug> --title "..."`. It owns the number, writes the skeleton and adds the index row; doing those three by hand and forgetting one leaves the log inconsistent.
